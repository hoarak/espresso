...
/** Tune P3M parameters to desired accuracy.
    ...
    Usage:
    \verbatim inter coulomb <bjerrum> p3m tune accuracy <value> [r_cut <value>
...
inline double p3m_pair_energy(double chgfac, double *d, double dist2,
                              double dist) {
