...
public:
  ...
  index_t grid_volume;       /** total number (volume) of local lattice sites
                                (excluding halo) */
  ...
  void
      *_data; /** pointer to the actual lattice data. This can be a contiguous
                 field of arbitrary data. */
  ...
  void set_data_for_global_position_with_periodic_image(double *pos,
                                                        void *data);
  ...
  int map_global_index_to_halo_index(index_t *global_index,
                                     index_t *halo_index);
   ...
   */
  void map_position_to_lattice(const double pos[3], index_t node_index[8],
                               double delta[6]);
   ...
   */
  static void map_position_to_lattice_global(double pos[3], int ind[3],
