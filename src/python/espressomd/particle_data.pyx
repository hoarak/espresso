...
cdef class ParticleHandle(object):
    ...
    property f:
        ...
        def __get__(self):
            global time_step
            self.update_particle_data()
            return np.array([self.particle_data.f()[0] * self.particle_data.p.mass / (0.5 * time_step**2),
                             self.particle_data.f()[1] * self.particle_data.p.mass / (0.5 * time_step**2),
                             self.particle_data.f()[2] * self.particle_data.p.mass / (0.5 * time_step**2)])
